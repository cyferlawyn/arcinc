class MainScene extends Scene{
    ...
    updateGui() {
        ...
        this.objectStore.get('shield').text = '' + Utils.format(Math.floor(player.currentShield), 3)  + ' / ' + Utils.format(Math.floor(player.stats.effectiveMaxShield), 3);
        ...
        this.objectStore.get('armor').text = '' + Utils.format(Math.floor(player.currentArmor), 3)  + ' / ' + Utils.format(Math.floor(player.stats.effectiveMaxArmor), 3);
        ...
        this.objectStore.get('energy').text = '' + Utils.format(Math.floor(player.currentEnergy), 3)  + ' / ' + Utils.format(Math.floor(player.stats.effectiveMaxEnergy), 3);
